  ...
  return (
    <section className="artists-section" id="artists">
                ...
                >
                  ...
                  <div className="artist-card-face artist-card-front">
                    <div className="artist-image-wrapper">
                      ...
                      />
                      <div className="artist-specialty-badge">
                        {artist.specialty}
                      </div>
                    </div>
                    <div className="artist-info">
                      ...
                      <p className="artist-bio">
                        Specializing in {artist.specialty} designs
                        with a focus on creating unique, personalized artwork
                        for each client.
                      </p>
                      <div className="artist-card-footer">
                        <span className="flip-hint">Click to reverse</span>
      ...
      <div className="ButtonContainer">
        <button className="CTAButton" onClick={() => console.log(artists)}>
