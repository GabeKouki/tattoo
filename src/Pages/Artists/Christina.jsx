...
import ChristinasPhoto from '../../Images/Christina.jpg';
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const { data: artistData, error: artistError } = await supabase
        .from('users')
        .select('id')
        .eq('email', 'tattoos.by.christinaa@gmail.com') // Ensure email matches the one in your database
        .single();
    ...
    <div className="ArtistPage">
      <section className="ArtistIntro">
        <div className="ArtistProfile">
          <img src={ChristinasPhoto} alt="Audrey" className="ArtistImage" />
          <div className="ArtistInfo">
            <h1>Christina LastName</h1>
            <p className="ArtistBio">
              I'm Christina, a passionate tattoo artist specializing in creating
